...
public class ManagerController {
	...
	public void displayPayrollDetails(int eId) {
		...
		try {
			...
			if(frequency == 1) {
				LocalDate nextMonday = currDate.with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY));
			...
			System.out.println("G. Units: ");
			System.out.println("H. Earnings(Current): ");
			System.out.println("I. Earnings(Till Date): ");
